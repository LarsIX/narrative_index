...
# get folder relative to this file
...
from corpus_cleaning import clean_article_corpus
from section_filtering import filter_article_by_section
...
def clean_database(year: int = typer.Option(..., help="Target year (e.g., 2023, 2024, 2025)")):
    ...
    raw_base = repo_root / "data" / "raw" / "articles"
    processed_base = repo_root / "data" / "processed" / "articles"
    ...
    db_path = raw_base / db_filenames[year]
    ...
    removed_dir = repo_root / "data" / "logs" / "filtered_out"
    removed_dir.mkdir(parents=True, exist_ok=True)

    removed_csv_path = removed_dir / f"removed_articles_{year}.csv"
    ...
    clean_db_path = processed_base / clean_filenames[year]
